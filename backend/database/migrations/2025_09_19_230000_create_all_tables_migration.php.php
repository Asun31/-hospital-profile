...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('rawatjalan_m', function (Blueprint $table) {
            $table->id();
            $table->string('img');
            $table->string('title');
            $table->text('content');
        ...
        Schema::create('rawatinap_m', function (Blueprint $table) {
            $table->id();
            $table->string('img');
            $table->string('title');
            $table->text('content');
        ...
        Schema::create('laboratorium_m', function (Blueprint $table) {
            $table->id();
            $table->string('img');
            $table->string('title');
            $table->text('content');
        ...
        Schema::create('radiologi_m', function (Blueprint $table) {
            $table->id();
            $table->string('img');
            $table->string('title');
            $table->text('content');
        ...
        Schema::create('sosmed_m', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            $table->text('content');
            $table->timestamps();
    ...
    public function down(): void
    {
        $tables = [
            ...
            'artikel_m','rawatjalan_m','rawatinap_m','laboratorium_m','radiologi_m','sosmed_m'
        ];
